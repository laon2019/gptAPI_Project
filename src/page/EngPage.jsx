...
const EngPage = () => {
  ...
  const handleClick = async () => {
    setLoading(true);
    const prompt = `
      영어 단어 시험을 볼 수 있도록 영어와 뜻을 다양하고 랜덤하게 보내줘.
      영어 단어가 매번 안곂치도록 다양한 카테고리로 보내줘
      영어 난이도는 중급에서 상급으로 보내줘 어려운거 보내줘
      JSON 형식으로 key에는 영어, value에는 뜻을 넣어서
      [{"단어": "hello", "뜻": "안녕하세요"}...] 형식으로 20개를 보내줘.
    `;
